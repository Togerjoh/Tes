...
print("{red}██████╦╝╚██████╔╝██████╔╝██████╔╝██║██████╔╝")
print("{red}╚═════╝░░╚═════╝░╚═════╝░╚═════╝░╚═╝╚═════╝░")
print("{bl}Tools Created By : @iSupportSG")
print("{bl}Credit : Thanks To All !")
print("{bl}Community : @TeamiRaid")
print("--------------------------------------------------------------------------------")
auth = input(f'{red}[{white}SG{red}] {white}Enter X-Authorization : {yellow} ')
